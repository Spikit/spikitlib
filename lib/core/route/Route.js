...
class Route {
    ...
    static get(routePath, controller) {
        ...
        this._router.get((req, res, next) => __awaiter(this, void 0, void 0, function* () {
            yield Route._runRoute(controller, req, res, next);
        }));
        return this._router;
    }
    ...
    static _runController(req, res, controller, next) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof controller == 'function') {
                let response = yield controller(req, res, next);
    ...
    static _runRoute(controller, req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            let response;
            try {
                _1.App.host = `${req.protocol}://${req.get('host')}`;
                controller = yield Route._getController(controller);
                response = yield Route._runController(req, res, controller, next);
            }
            catch (e) {
