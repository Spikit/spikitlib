...
class Route {
    ...
    static get(routePath, controller) {
        ...
        _1.App.router.get(this.lastRoute, this.currentMiddleware, function (req, res) {
    ...
    static post(routePath, controller) {
        this.lastRoute = this._getPath(routePath);
        _1.App.router.post(this.lastRoute, this.currentMiddleware, function (req, res) {
            return __awaiter(this, void 0, void 0, function* () {
                yield Route._runRoute(controller, req, res);
            });
        });
    ...
    static put(routePath, controller) {
        this.lastRoute = this._getPath(routePath);
        _1.App.router.put(this.lastRoute, this.currentMiddleware, function (req, res) {
            return __awaiter(this, void 0, void 0, function* () {
                yield Route._runRoute(controller, req, res);
            });
        });
    ...
    static delete(routePath, controller) {
        this.lastRoute = this._getPath(routePath);
        _1.App.router.delete(this.lastRoute, this.currentMiddleware, function (req, res) {
            return __awaiter(this, void 0, void 0, function* () {
                yield Route._runRoute(controller, req, res);
            });
        });
    ...
    static patch(routePath, controller) {
        this.lastRoute = this._getPath(routePath);
        _1.App.router.patch(this._getPath(routePath), this.currentMiddleware, function (req, res) {
            return __awaiter(this, void 0, void 0, function* () {
                yield Route._runRoute(controller, req, res);
            });
        });
    ...
    static all(routePath, controller) {
        this.lastRoute = this._getPath(routePath);
        _1.App.router.all(this._getPath(routePath), this.currentMiddleware, function (req, res) {
            return __awaiter(this, void 0, void 0, function* () {
                yield Route._runRoute(controller, req, res);
            });
        });
    ...
    static middleware(...routeMiddleware) {
        routeMiddleware.forEach(m => {
            let mw = new _1.App.kernel.routeMiddleware[m];
            if (mw) {
                _1.App.router.route(this.lastRoute).all(mw.handle.bind(mw));
            }
            else {
