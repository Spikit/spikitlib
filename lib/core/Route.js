...
class Route {
    ...
    static get(routePath, controller) {
        ...
        App_1.App.express.get(this.lastRoute, this.currentMiddleware, function (req, res) {
    ...
    static post(routePath, controller) {
        this.lastRoute = this._getPath(routePath);
        App_1.App.express.post(this.lastRoute, this.currentMiddleware, function (req, res) {
            return __awaiter(this, void 0, void 0, function* () {
                yield Route._runRoute(controller, req, res);
            });
        });
    ...
    static put(routePath, controller) {
        this.lastRoute = this._getPath(routePath);
        App_1.App.express.put(this.lastRoute, this.currentMiddleware, function (req, res) {
            return __awaiter(this, void 0, void 0, function* () {
                yield Route._runRoute(controller, req, res);
            });
        });
    ...
    static delete(routePath, controller) {
        this.lastRoute = this._getPath(routePath);
        App_1.App.express.delete(this.lastRoute, this.currentMiddleware, function (req, res) {
            return __awaiter(this, void 0, void 0, function* () {
                yield Route._runRoute(controller, req, res);
            });
        });
    ...
    static patch(routePath, controller) {
        this.lastRoute = this._getPath(routePath);
        App_1.App.express.patch(this._getPath(routePath), this.currentMiddleware, function (req, res) {
            return __awaiter(this, void 0, void 0, function* () {
                yield Route._runRoute(controller, req, res);
            });
        });
    ...
    static all(routePath, controller) {
        this.lastRoute = this._getPath(routePath);
        App_1.App.express.all(this._getPath(routePath), this.currentMiddleware, function (req, res) {
            return __awaiter(this, void 0, void 0, function* () {
                yield Route._runRoute(controller, req, res);
            });
        });
    ...
    static _runController(req, res, controller) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof controller == 'function') {
                ...
                if (response instanceof View_1.default) {
                    let trans = new Translation_1.Translation(req.locale || 'en');
                    response.data['route'] = Urls_1.Urls.route;
                    response.data['url'] = Urls_1.Urls.url;
                    response.data['slug'] = Strings_1.Strings.slug;
                ...
                else if (response instanceof Response_1.default) {
            ...
            let error = new View_1.default('error.404');
            res.status(404);
    ...
    static _runRoute(controller, req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            App_1.App.host = `${req.protocol}://${req.get('host')}`;
